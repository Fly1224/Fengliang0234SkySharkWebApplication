<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ConfirmRes.aspx.cs" Inherits="FangLiangProject4SkySharkWebApp.LOB.ConfirmRes" %>
    ...
    <div class ="tabContents">
        <table >
            ...
            <tr>
                ...
                <td>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Please specify a valid ticket No." ControlToValidate="txtTNo"></asp:RequiredFieldValidator></td>
            </tr>
            <tr>
                <td></td>
                <td>
                    <asp:Button ID="btnCinfirm" runat="server" Text="Submit" /></td>
                <td></td>
            </tr>
            <tr>
                <td></td>
